            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">                                       <!--oldとは　バリデーション中も保持(戻っても表示されてる)-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="radio" name="gender" value="男性" @if ($profile->gender == "男性") checked @endif> 男性
                            <input type="radio" name="gender" value="女性" @if ($profile->gender == "女性") checked @endif> 女性
                        </div>
                    </div>
                    <div class="form-group row">
